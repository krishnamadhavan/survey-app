...
class Survey(models.Model):
    ...
    a1 = models.CharField(max_length=24, verbose_name=_('a1'), choices=a1_choices, blank=True, null=True)
    a2 = models.TextField(verbose_name=_('a2'), blank=True, null=True)
    a3 = models.TextField(verbose_name=_('a3'), choices=a3_choices, blank=True, null=True)
    a3_code = models.IntegerField(verbose_name=_('a3_code'), choices=a3_code_choices, blank=True, null=True)
    a4 = models.CharField(max_length=8, verbose_name=_('a4'), choices=a4_choices, blank=True, null=True)
    a5 = models.TextField(verbose_name=_('a5'), choices=a5_choices, blank=True, null=True)
    a5_code = models.TextField(verbose_name=_('a5_code'), choices=a5_code_choices, blank=True, null=True)
    a6_name = models.TextField(verbose_name=_('a6_name'), blank=True, null=True)
    a6_part_no = models.TextField(verbose_name=_('a6_part_no'), blank=True, null=True)
    a7 = models.TextField(verbose_name=_('a7'), blank=True, null=True)
    a8 = models.TextField(verbose_name=_('a8'), blank=True, null=True)
    ...
    a12 = models.CharField(max_length=64, verbose_name=_('a12'), choices=a12_choices, blank=True, null=True)
    a13 = models.TextField(verbose_name=_('a13'), blank=True, null=True)
    a14 = models.TextField(verbose_name=_('a14'), blank=True, null=True)
    a15 = models.CharField(max_length=16, verbose_name=_('a15'), choices=bool_choices, blank=True, null=True)
    a16 = models.CharField(max_length=16, verbose_name=_('a16'), choices=bool_choices, blank=True, null=True)
    a17 = models.CharField(max_length=16, verbose_name=_('a17'), choices=bool_choices, blank=True, null=True)
    b1 = models.IntegerField(verbose_name=_('b1'), default=1, blank=True, null=True)
    b2 = models.IntegerField(verbose_name=_('b2'), default=0, blank=True, null=True)
    b12 = models.IntegerField(verbose_name=_('b12'), default=0, blank=True, null=True)
    b13 = models.IntegerField(verbose_name=_('b13'), default=0, blank=True, null=True)
    c1 = models.IntegerField(verbose_name=_('c1'), default=98, blank=True, null=True)
    ...
    d5 = models.TextField(verbose_name=_('d5'), blank=True, null=True)
    ...
    e3 = models.CharField(max_length=128, verbose_name=_('e3'), choices=e3_choices, blank=True, null=True)
    e4a = models.CharField(max_length=128, verbose_name=_('e4a'), choices=e4_choices, blank=True, null=True)
    e4b = models.CharField(max_length=128, verbose_name=_('e4b'), choices=e4_choices, blank=True, null=True)
    e4c = models.CharField(max_length=128, verbose_name=_('e4c'), choices=e4_choices, blank=True, null=True)
    e5a = models.CharField(max_length=128, verbose_name=_('e5a'), choices=e5_choices, blank=True, null=True)
    e5b = models.CharField(max_length=128, verbose_name=_('e5b'), choices=e5_choices, blank=True, null=True)
    e5c = models.CharField(max_length=128, verbose_name=_('e5c'), choices=e5_choices, blank=True, null=True)
    e5d = models.CharField(max_length=128, verbose_name=_('e5d'), choices=e5_choices, blank=True, null=True)
    e5e = models.CharField(max_length=128, verbose_name=_('e5e'), choices=e5_choices, blank=True, null=True)
    e5f = models.CharField(max_length=128, verbose_name=_('e5f'), choices=e5_choices, blank=True, null=True)
    e5g = models.CharField(max_length=128, verbose_name=_('e5g'), choices=e5_choices, blank=True, null=True)
    ...
    f3 = models.TextField(verbose_name=_('f3'), blank=True, null=True)
    ...
    f5a = models.CharField(max_length=128, verbose_name=_('f5a'), choices=bool_choices, blank=True, null=True)
    f5b = models.CharField(max_length=128, verbose_name=_('f5b'), choices=bool_choices, blank=True, null=True)
    f5c = models.CharField(max_length=128, verbose_name=_('f5c'), choices=bool_choices, blank=True, null=True)
    f5d = models.CharField(max_length=128, verbose_name=_('f5d'), choices=bool_choices, blank=True, null=True)
    f6 = models.CharField(max_length=128, verbose_name=_('f6'), choices=null_boolean_choices, blank=True, null=True)
    f7 = models.CharField(max_length=128, verbose_name=_('f7'), choices=f7_choices, blank=True, null=True)
    f8 = models.CharField(max_length=128, verbose_name=_('f8'), choices=somewhat_choices, blank=True, null=True)
    f9 = models.CharField(max_length=128, verbose_name=_('f9'), choices=f9_choices, blank=True, null=True)
    f10 = models.CharField(max_length=128, verbose_name=_('f10'), choices=f10_choices, blank=True, null=True)
    f11 = models.CharField(max_length=128, verbose_name=_('f11'), choices=somewhat_choices, blank=True, null=True)
    g1 = models.CharField(max_length=128, verbose_name=_('g1'), choices=g1_choices, blank=True, null=True)
    g2 = models.CharField(max_length=128, verbose_name=_('g2'), choices=g2_choices, blank=True, null=True)
    g3 = models.CharField(max_length=128, verbose_name=_('g3'), choices=g3_choices, blank=True, null=True)
    g4 = models.CharField(max_length=128, verbose_name=_('g4'), choices=g4_choices, blank=True, null=True)
    g5a = models.CharField(max_length=128, verbose_name=_('g5a'), choices=g5_choices, blank=True, null=True)
    g5b = models.CharField(max_length=128, verbose_name=_('g5b'), choices=g5_choices, blank=True, null=True)
    g5c = models.CharField(max_length=128, verbose_name=_('g5c'), choices=g5_choices, blank=True, null=True)
    g5d = models.CharField(max_length=128, verbose_name=_('g5d'), choices=g5_choices, blank=True, null=True)
    g6 = models.CharField(max_length=128, verbose_name=_('g6'), choices=g6_choices, blank=True, null=True)
    h1 = models.CharField(max_length=128, verbose_name=_('h1'), choices=bool_choices, blank=True, null=True)
    h2 = models.CharField(max_length=128, verbose_name=_('h2'), choices=bool_choices, blank=True, null=True)
...
class FamilyDetails(models.Model):
    ...
    enrolled = models.CharField(max_length=128, verbose_name=_('Enrolled'), choices=enroll_choices, blank=True,
                                null=True)
    has_voted_in_lok_sabha = models.CharField(max_length=128, verbose_name=_('Voted in Lok Sabha'),
                                              choices=bool_choices, blank=True, null=True)
