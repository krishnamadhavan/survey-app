...
class Survey(models.Model):
    ...
    a1 = models.CharField(max_length=254, verbose_name=_('a1'), choices=a1_choices)
    a2 = models.CharField(max_length=254, verbose_name=_('a2'))
    a3 = models.CharField(max_length=254, verbose_name=_('a3'))
    a4 = models.CharField(max_length=254, verbose_name=_('a4'), choices=a4_choices)
    a5 = models.CharField(max_length=254, verbose_name=_('a5'), blank=True, null=True)
    a6 = models.CharField(max_length=254, verbose_name=_('a6'))
    a7 = models.CharField(max_length=254, verbose_name=_('a7'))
    a8 = models.CharField(max_length=254, verbose_name=_('a8'))
    a9 = models.CharField(max_length=254, verbose_name=_('a9'), blank=True, null=True)
    a10 = models.CharField(max_length=254, verbose_name=_('a10'), blank=True, null=True)
    a11 = models.CharField(max_length=254, verbose_name=_('a11'), blank=True, null=True)
    a12 = models.CharField(max_length=254, verbose_name=_('a12'), choices=a12_choices)
    a13 = models.CharField(max_length=254,  verbose_name=_('a13'))
    a14 = models.CharField(max_length=254,  verbose_name=_('a14'))
    a15 = models.CharField(max_length=254, verbose_name=_('a15'), choices=bool_choices)
    a16 = models.CharField(max_length=254, verbose_name=_('a16'), choices=bool_choices)
    a17 = models.CharField(max_length=254, verbose_name=_('a17'), choices=bool_choices)
    ...
    c2 = models.CharField(max_length=254, verbose_name=_('c2'), choices=null_boolean_choices, blank=True, null=True)
    c3 = models.CharField(max_length=254, verbose_name=_('c3'), choices=c3_choices)
    c4 = models.CharField(max_length=254, verbose_name=_('c4'), choices=bool_choices, blank=True, null=True)
    c5 = models.CharField(max_length=254, verbose_name=_('c5'), choices=c5_choices)
    c6 = models.CharField(max_length=254, verbose_name=_('c6'), choices=c6_choices, blank=True, null=True)
    c7 = models.CharField(max_length=254, verbose_name=_('c7'), choices=c7_choices, blank=True, null=True)
    c8 = models.CharField(max_length=254, verbose_name=_('c8'), choices=bool_choices, blank=True, null=True)
    c9 = models.CharField(max_length=254, verbose_name=_('c9'), choices=c9_choices, blank=True, null=True)
    c10 = models.CharField(max_length=254, verbose_name=_('c10'), choices=c10_choices, blank=True, null=True)
    d1 = models.CharField(max_length=254, verbose_name=_('d1'), choices=bool_choices)
    d2 = models.CharField(max_length=254, verbose_name=_('d2'), choices=bool_choices)
    d3 = models.CharField(max_length=254, verbose_name=_('d3'), choices=d3_choices)
    d4a = models.CharField(max_length=254, verbose_name=_('d4a'), choices=null_boolean_choices)
    d4b = models.CharField(max_length=254, verbose_name=_('d4b'), choices=null_boolean_choices)
    d4c = models.CharField(max_length=254, verbose_name=_('d4c'), choices=null_boolean_choices)
    d4d = models.CharField(max_length=254, verbose_name=_('d4d'), choices=null_boolean_choices)
    d4e = models.CharField(max_length=254, verbose_name=_('d4e'), choices=null_boolean_choices)
    d4f = models.CharField(max_length=254, verbose_name=_('d4f'), choices=null_boolean_choices)
    d4g = models.CharField(max_length=254, verbose_name=_('d4g'), choices=null_boolean_choices)
    d4h = models.CharField(max_length=254, verbose_name=_('d4h'), choices=null_boolean_choices)
    d4i = models.CharField(max_length=254, verbose_name=_('d4i'), choices=null_boolean_choices)
    d4j = models.CharField(max_length=254, verbose_name=_('d4j'), choices=null_boolean_choices)
    d4k = models.CharField(max_length=254, verbose_name=_('d4k'), choices=null_boolean_choices)
    d5 = models.CharField(max_length=254, verbose_name=_('d5'), choices=bool_choices, blank=True, null=True)
    d6 = models.CharField(max_length=254, verbose_name=_('d6'), choices=d6_choices, blank=True, null=True)
    d7 = models.CharField(max_length=254, verbose_name=_('d7'), choices=d7_choices, blank=True, null=True)
    e1 = models.IntegerField(verbose_name=_('e1'), default=99)
    e2 = models.CharField(max_length=254, verbose_name=_('e2'), choices=e2_choices)
    e3 = models.CharField(max_length=254, verbose_name=_('e3'), choices=e3_choices)
    e4a = models.CharField(max_length=254, verbose_name=_('e4a'), choices=e4_choices)
    e4b = models.CharField(max_length=254, verbose_name=_('e4b'), choices=e4_choices)
    e4c = models.CharField(max_length=254, verbose_name=_('e4c'), choices=e4_choices)
    e5a = models.CharField(max_length=254, verbose_name=_('e5a'), choices=e5_choices)
    e5b = models.CharField(max_length=254, verbose_name=_('e5b'), choices=e5_choices)
    e5c = models.CharField(max_length=254, verbose_name=_('e5c'), choices=e5_choices)
    e5d = models.CharField(max_length=254, verbose_name=_('e5d'), choices=e5_choices)
    e5e = models.CharField(max_length=254, verbose_name=_('e5e'), choices=e5_choices)
    e5f = models.CharField(max_length=254, verbose_name=_('e5f'), choices=e5_choices)
    e5g = models.CharField(max_length=254, verbose_name=_('e5g'), choices=e5_choices)
    e5h = models.CharField(max_length=254, verbose_name=_('e5h'), choices=e5_choices)
    f1 = models.CharField(max_length=254, verbose_name=_('f1'), choices=null_boolean_choices)
    f2 = models.CharField(max_length=254, verbose_name=_('f2'), choices=f2_choices)
    f3 = models.CharField(max_length=254, verbose_name=_('f3'), choices=f3_choices)
    f4 = models.CharField(max_length=254, verbose_name=_('f4'), choices=null_boolean_choices, blank=True, null=True)
    f5 = models.CharField(max_length=254, verbose_name=_('f5'), choices=f5_choices)
    f6 = models.CharField(max_length=254, verbose_name=_('f6'), choices=null_boolean_choices)
    f7 = models.CharField(max_length=254, verbose_name=_('f7'), choices=f7_choices)
    f8 = models.CharField(max_length=254, verbose_name=_('f8'), choices=somewhat_choices)
    f9 = models.CharField(max_length=254, verbose_name=_('f9'), choices=null_boolean_choices)
    f10 = models.CharField(max_length=254, verbose_name=_('f10'), choices=f10_choices)
    f11 = models.CharField(max_length=254, verbose_name=_('f11'), choices=somewhat_choices)
    f12a = models.CharField(max_length=254, verbose_name=_('f12a'), choices=null_boolean_choices)
    f12b = models.CharField(max_length=254, verbose_name=_('f12b'), choices=null_boolean_choices)
    f12c = models.CharField(max_length=254, verbose_name=_('f12c'), choices=null_boolean_choices)
    f12d = models.CharField(max_length=254, verbose_name=_('f12d'), choices=null_boolean_choices)
    f12e = models.CharField(max_length=254, verbose_name=_('f12e'), choices=null_boolean_choices)
    f12f = models.CharField(max_length=254, verbose_name=_('f12f'), choices=null_boolean_choices)
    g1 = models.CharField(max_length=254, verbose_name=_('g1'), choices=g1_choices)
    g2 = models.CharField(max_length=254, verbose_name=_('g2'), choices=g2_choices)
    g3 = models.CharField(max_length=254, verbose_name=_('g3'), choices=g3_choices)
    g4 = models.CharField(max_length=254, verbose_name=_('g4'), choices=g4_choices)
    g5a = models.CharField(max_length=254, verbose_name=_('g5a'), choices=g5_choices)
    g5b = models.CharField(max_length=254, verbose_name=_('g5b'), choices=g5_choices)
    g5c = models.CharField(max_length=254, verbose_name=_('g5c'), choices=g5_choices)
    g5d = models.CharField(max_length=254, verbose_name=_('g5d'), choices=g5_choices)
    g6 = models.CharField(max_length=254, verbose_name=_('g6'), choices=g6_choices)
    h1 = models.CharField(max_length=254, verbose_name=_('h1'), choices=bool_choices)
    h2 = models.CharField(max_length=254, verbose_name=_('h2'), choices=bool_choices)
    h3 = models.CharField(max_length=254, verbose_name=_('h3'), blank=True, null=True)
    h4 = models.CharField(max_length=254, verbose_name=_('h4'), blank=True, null=True)
...
class FamilyDetails(models.Model):
    ...
    relationship = models.CharField(max_length=254, verbose_name=_('Relationship with HH'),
                                    choices=relationship_choices)
    sex = models.CharField(max_length=254, verbose_name=_('Sex'), choices=sex_choices)
    disabled = models.CharField(max_length=254, verbose_name=_('Disabled'), choices=disability_choices)
    migration = models.CharField(max_length=254, verbose_name=_('Migrated in last 1 year'), choices=bool_choices)
    enrolled = models.CharField(max_length=254, verbose_name=_('Enrolled'), choices=enroll_choices)
    has_voted_in_lok_sabha = models.CharField(max_length=254, verbose_name=_('Voted in Lok Sabha'),
                                              choices=bool_choices)
    has_voted_in_assembly = models.CharField(max_length=254, verbose_name=_('Voted in Assembly election'),
                                             choices=bool_choices)
